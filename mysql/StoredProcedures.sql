...
BEGIN
   ...
   END IF;
   IF Operacion = 'D' THEN /*GET NO ASESORIAS DIA*/
   ...
   IF Operacion = 'H' THEN /*GET ASESORIAS DIA*/
	SELECT Asesoria_id,hora,nombreMateria,lugar,costo,CONCAT(nombres,' ',apellidos) AS nombreCompleto FROM Asesoria INNER JOIN Usuario
