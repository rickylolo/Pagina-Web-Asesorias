    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <img src="imgs/logo.jpg" alt="image" id="imagenModal">
          <h1 class="modal-title" id="exampleModalLabel">Añadir Materia</h1>
          <button type="button" class="btn-close" id="closeModalMateria" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-12 d-flex justify-content-center">
              <h3 class="text-secondary">Materia:</h3>
            </div>
        
             <div class="col-12 d-flex justify-content-center">
              <input type="text" class="form-control" id="nombreMateria" name="nombreMateria"  aria-label="Descripcion" aria-describedby="basic-addon1">
             </div>
          </div>
          <div class="row">
            <div class="col-12 d-flex justify-content-center">
               <h3 class="text-secondary">Descripcion:</h3>
            </div>
      
               <div class="col-12 d-flex justify-content-center">
              <input type="text" class="form-control" id="Descripcion" name="Descripcion" aria-label="Descripcion" aria-describedby="basic-addon1">
       </div>
          </div>
          <div class="row">
            <div class="col-12 d-flex justify-content-center">
              <h3 class="text-secondary">Lugar:</h3>
            </div>
       <div class="col-12 d-flex justify-content-center">
              <input type="text" class="form-control" id="Lugar" name="Lugar"  aria-label="Descripcion" aria-describedby="basic-addon1">
      </div>
          </div>
          <div class="row">
            <div class="col-12 d-flex justify-content-center">
         <h3 class="text-secondary">Costo:</h3>
            </div>
            <div class="col-12 d-flex justify-content-center">
                  <input type="text" class="form-control" id="Costo" name="Costo"  aria-label="Descripcion" aria-describedby="basic-addon1">
        </div>
          </div>
        </div>
        <div class="modal-footer">
          <div class="d-flex mx-auto">
            <button type="button" class="btn--full" data-bs-dismiss="modal" id="GuardarAsesoria">Guardar</button>
            <button type="button" class="btn--full" id="limpiarCamposAsesoria">Limpiar</button>
            <button type="button" class="btn--full" data-bs-dismiss="modal">Cancelar</button>
          </div>
        </div>
      </div>
    </div>
