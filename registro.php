...
<body>
  ...
  <section class="section-hero">
    ...
    <form class="cta-form" method="post" enctype="multipart/form-data">
      <div>
      ...
      <div>
        ...
        <input type="text" placeholder="Matricula" name="matricula" id="matricula" required>
      </div>
      ...
      <a class="btn btn--form" href="index.html">Regresar</a>
